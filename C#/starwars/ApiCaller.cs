...
namespace starwars
{
    public class WebRequest
    {
        ...
        public static async Task GetDataAsync(string person, Action<Dictionary<string, object>> Callback)
        {
            ...
            using (var Client = new HttpClient())
            {
                try
                {
                    Client.BaseAddress = new Uri($"https://swapi.co/api/people/?search={person}");
